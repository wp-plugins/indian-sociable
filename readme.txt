...
Currently this plugin supports: BestofIndya, BharatBoom, Humsurfer, IndiaBol, IndianBytes, IndianTags, Newzly, Rambhai and Spotonce
...
1. Get [Sociable](http://wordpress.org/extend/plugins/sociable/) Plugin and install it first.
1. Unzip the `sociable-india.zip` file. 
1. Upload the the `indian_sociable` folder (not just the files in it!) to your `wp-contents/plugins` folder. If you're using FTP, use 'binary' mode.
1. In your WordPress administration, go to the Plugins page
1. Activate the Indian Sociable plugin and visit Sociable in Options Menu.
